        ...
        <Row>
          <Col lg="6" md="6">
            <div className="about__section-content">
              <h4 className="section__subtitle" style={{ color: '#000' }}>A propos </h4>
              <h2 className="section__title" style={{ color: '#FF8300' }}>Bienvenue au service de location de voitures</h2>
